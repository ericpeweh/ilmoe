...
const Courses = () => {
  return (
    <div className="bg-yellow-pastel relative -left-3 p-8 overflow-y-auto rounded-l-2xl">
      ...
      <div className="my-4 text-sm uppercase font-semibold text-purple-pastel">
        Design
      </div>
      ...
      <div className="mt-8 mb-4 text-sm uppercase font-semibold text-purple-pastel">
        Other Courses
      </div>
      <div className="grid gap-y-3">
        <CoursesCard
